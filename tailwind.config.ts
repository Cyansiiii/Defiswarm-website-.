		...
		extend: {
			...
			keyframes: {
                ...
                'pulse-glow': {
                    '0%, 100%': { 
                        opacity: '1',
                        boxShadow: '0 0 10px rgba(0, 226, 255, 0.7), 0 0 20px rgba(0, 226, 255, 0.5)' 
                    },
                    '50%': { 
                        opacity: '0.8',
                        boxShadow: '0 0 15px rgba(0, 226, 255, 0.9), 0 0 30px rgba(0, 226, 255, 0.7)' 
                    }
                },
                'float': {
